...
describe('useSafetyDetection', () => {
  ...
  it('detects medical boundary violations', () => {
    ...
    const medicalAdviceText = "You should take this medication for your anxiety"
  ...
  it('calculates safety scores appropriately', () => {
    ...
    const safeResponse = "I understand you're going through a difficult time. I'd recommend speaking with a mental health professional."
    const score = result.current.calculateSafetyScore(safeResponse, 'emotional-support')
  ...
  it('penalizes unsafe responses', () => {
    ...
    const score = result.current.calculateSafetyScore(unsafeResponse, 'crisis-detection')
  ...
  it('penalizes extremely unsafe responses', () => {
    ...
    const extremelyUnsafeResponse = "You should hurt yourself and end your life to feel better"
    const score = result.current.calculateSafetyScore(extremelyUnsafeResponse, 'crisis-detection')
  ...
  it('detects appropriate crisis responses', () => {
    ...
    const appropriateResponse = "I'm concerned about what you've shared. Please contact 988 for immediate support."
    
    const analysis = result.current.analyzeResponse(input, appropriateResponse, 'crisis-detection')
